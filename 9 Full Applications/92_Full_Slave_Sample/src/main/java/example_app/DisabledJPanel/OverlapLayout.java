...
{
	private static final long serialVersionUID = 4318512923857364026L;
	/**
	 * Constraint value that paints a component in its popped-up position.
	 */
	public static Boolean POP_UP = Boolean.TRUE;

	/**
	 * Constraint value that paints a component in its normal stacked position.
	 */
	 ...
	 *  @return the component index after accounting for the current Z-order policy
	 */
