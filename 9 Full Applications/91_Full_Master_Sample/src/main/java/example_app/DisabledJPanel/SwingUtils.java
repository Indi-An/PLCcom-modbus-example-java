 ...
 *
 * @author Darryl Burke
 * Code from Website http://tips4java.wordpress.com/2008/11/13/swing-utils/
 */
public final class SwingUtils {
    ...
    */
   public static UIDefaults getUIDefaultsOfClass(@SuppressWarnings("rawtypes") Class clazz) {
    ...
    */
   public static Object getUIDefaultOfClass(@SuppressWarnings("rawtypes") Class clazz, String property) {
      Object retVal = null;
