package example_app.DisabledJPanel;
...
/**
 *  Code from Website http://tips4java.wordpress.com/2009/08/02/disabled-panel/
 ...
 */
public class DisabledJPanel extends JPanel
{
	private static final long serialVersionUID = 5664320479220680903L;
	 ...
	 */
	public DisabledJPanel(Container container)
	{
		this(container, null);
	}
	 ...
	 *  @param container a Container to be added to this DisabledPanel
	 */
	public DisabledJPanel(Container container, Color disabledColor)
	{
	...
	{
		private static final long serialVersionUID = -5259882839015299330L;
	...
	{
		private Map<DisabledJPanel, Set<KeyStroke>> panels =
			new HashMap<DisabledJPanel, Set<KeyStroke>>();
		 ...
		 *
		 *  @param panel the disabled panel whose key bindings should be tracked
		 */
		public void addPanel(DisabledJPanel panel)
		{
		 ...
		 */
		private Set<KeyStroke> getKeyStrokes(DisabledJPanel panel)
		{
		 ...
		 *
		 *  @param panel the disabled panel whose key bindings should no longer be tracked
		 */
		public void removePanel(DisabledJPanel panel)
		{
		...
		protected void dispatchEvent(AWTEvent event)
		{
			...
			||  event.getID() == KeyEvent.KEY_RELEASED)
			{
				...
				for (DisabledJPanel panel: panels.keySet())
				{
		 ...
		 */
		private boolean searchForKeyBinding(DisabledJPanel panel, KeyStroke keyStroke)
		{
		...
		{
			List<DisabledJPanel> panelsToRemove = new ArrayList<DisabledJPanel>();
			...
			for (DisabledJPanel panel: panelsToRemove)
			{
				removePanel( panel );
			}
