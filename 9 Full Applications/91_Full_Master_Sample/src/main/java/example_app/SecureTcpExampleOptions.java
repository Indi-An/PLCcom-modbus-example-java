...
final class SecureTcpExampleOptions {
	private static final String DEFAULT_OWN_CERTIFICATE_ALIAS = "PLCcom Modbus Master TestApp";
	...
	private static final String DEFAULT_APPLICATION_FOLDER = "ModbusMaster";
